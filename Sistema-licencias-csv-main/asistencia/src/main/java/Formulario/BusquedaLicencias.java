...
import TAD_Establecimiento.BusquedaImplEstablecimiento;
import TAD_Establecimiento.BusquedaLinealImplEstablecimiento;
...
public class BusquedaLicencias extends javax.swing.JFrame {
    ...
    void buscar() {
        ...
        BusquedaLinealImplEstablecimiento busquedaLineal = new BusquedaLinealImplEstablecimiento(lista);
        BusquedaImplEstablecimiento busquedaBinaria = new BusquedaImplEstablecimiento();
        busquedaBinaria.cabeza = lista.cabeza; // Asignar la lista cargada a la búsqueda binaria
        ...
        if (jCheckBoxRuc.isSelected() && !ruc.isEmpty()) {
            resultado = busquedaBinaria.buscarPorRuc(ruc);
        }

        // Verificar si se debe realizar la búsqueda por Giro (lineal)
        if (jCheckBoxGiro.isSelected() && !giro.isEmpty()) {
            ListaEnlazadaImplEstablecimiento resultadosGiro = busquedaLineal.buscarPorGiro(giro);
        ...
        if (jCheckBoxArea.isSelected() && area != null) {
            ListaEnlazadaImplEstablecimiento resultadosArea = busquedaLineal.buscarPorArea(area);
        ...
        if (jCheckBoxTipoLicencia.isSelected() && !tipoLicencia.isEmpty()) {
            ListaEnlazadaImplEstablecimiento resultadosLicencia = busquedaLineal.buscarPorTipoLicencia(tipoLicencia);
        ...
        NodoEstablecimiento actual = resultado.cabeza;
        while (actual != null) {
            Establecimiento establecimiento = actual.getEstablecimiento();
            Object[] datosEstablecimiento = new Object[]{
                establecimiento.getRuc_Estab(),
...
// Función para agregar los resultados de una búsqueda a otra lista
    ...
    private ListaEnlazadaImplEstablecimiento combinarResultados(ListaEnlazadaImplEstablecimiento resultado, ListaEnlazadaImplEstablecimiento nuevosResultados) {
        NodoEstablecimiento actual = nuevosResultados.cabeza;
        while (actual != null) {
            resultado.insertar(actual.getEstablecimiento());
            actual = actual.getSiguiente();
        }
        return resultado;
    }
